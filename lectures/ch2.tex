...
\item {\bf Thevenin's Theorem:}
  ...
  \item Find voltage $V$ in terms of the internal energy sources inside
    ...
    \item By the superposition principle, we get the load voltage 
      $V=V'+V''=V_{oc}-R_0I$. 
    \item The voltage $V$ and current $I$ in the circuit in (e) are also 
      related by the same equation $V=V_T-R_TI$, i.e., this circuit
...
\item {\bf Norton's Theorem:}
  ...
  $I_N$ in parallel with a resistor $R_N$, where}
  \begin{itemize}
  \item {\bf $I_N=I_{sc}$ is the short-circuit current of the network}
  \item {\bf $R_N=R_T$ is the same resistance as in Thevenin's theorem}.
  \end{itemize}
...
\htmladdimg{../figures/ch2Fig5.png}
...
\htmladdnormallink{Solution}{../ch2_sub5}
...
\htmladdimg{../figures/ch2Fig6.png}
...
%  \htmladdimg{../figures/AmplifierModel2.png}
  \htmladdimg{../figures/TransistorOpampModels.png}
  ...
  $G_v$, driven by either a current source $i_s=v_s/R_S$ or a voltage $v_s=i_sR_S$ 
