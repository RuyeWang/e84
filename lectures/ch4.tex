...
\htmladdnormallink{Boltzmann constant}
...
\item {\bf Common-Base (CB) configuration}
  ...
  \htmladdimg{../figures/CBnpn.gif}  \htmladdimg{../figures/CB3.png}
...
%    \begin{equation}   I_C=\alpha I_E+I_{CB0}\approx \alpha I_E    \end{equation}
...
\item {\bf Common-Emitter (CE) configuration}
  ...
  \htmladdimg{../figures/CEnpn.gif}  \htmladdimg{../figures/CE3.png}
...
\end{eqnarray}
% \begin{equation}	r_{be}=V_T/I_B=26\;mV/40\mu A=650 \;\Omega	\end{equation}
The AC variables:
\begin{equation}
...
\htmladdimg{../figures/EmitterFollower1.png}
...
\item \htmladdnormallink{{\bf Different Classes of Amplifier}}{http://en.wikipedia.org/wiki/Power_amplifier_classes} 
...
\item The \htmladdnormallink{Push-pull circuits}
...
broaccast channels to an \htmladdnormallink{\em intermediate frequency} 
...
\htmladdimg{../figures/tube.png}
\htmladdimg{../figures/tubePlot.png}
\htmladdimg{../figures/tubeAmplifier.png}
...
%\begin{equation}  V_{DS}=V_{out}-V_{in} \ge V_B-V_{in}-V_T \end{equation}
...
configuration is
\begin{equation}	i_g=0	\end{equation}
and
\begin{equation}	i_d=f(v_{gs}, v_{ds})=\frac{\partial i_d}{\partial v_{gs}} v_{gs}
...
\begin{equation}	i_{ds}=g_m v_{gs}	\end{equation}
...
\begin{equation}	V_{GS}=-I_D R	\end{equation}
\item {\bf Voltage Divider Biasing}

\htmladdimg{../figures/JFETbiasing2.gif}
\begin{equation}	V_{GS}=\frac{R_{g2}}{R_{g1}+R_{g2}} \;V_{DD}-I_D R \end{equation}
\end{itemize}
Also, common to both biasing methods, we have
\begin{equation}	V_{DS}=V_{DD}-I_D(R+R_d)	\end{equation}
and from the transfer characteristics:
\begin{equation}	I_D=I_{DSS}(1-V_{GS}/V_P)^2	\end{equation}
