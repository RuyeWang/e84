...
$\displaystyle \frac{v_{out}}{v_{in}}=\frac{1+(j\omega\tau)^2}{1+4j\omega\tau(1-\alpha)+(j\omega\tau)^2}$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmlinlinemathA{tex2html_wrap_indisplay384}%
$\displaystyle \frac{1+(j\omega\tau)^2}{1+4j\omega\tau R_4/(R_4+R_5)+(j\omega\tau)^2}
