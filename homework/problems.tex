...
\item In the circuit below, $v_S(t)=A\cos(10^6 t)$ with some unknown
  ...
  \htmladdimg{../Problems9.png}

  {\bf Solution} 

  \htmladdimg{../Problems8.png}
...
\item In the circuit below, $v_S(t)=A\cos(10^4 t)$, $R_1=R_2=R_3=20\,\Omega$.
  ...
  \[
  i_2=i_L=10\cos(\omega t-\pi/3),\;\;\;\;v_2=200\cos(\omega t-\pi/3),\;\;\;\;
  v_L=200\sqrt{3}\cos(\omega t+\pi/3)
  \]
  \[
  i_3=i_C=10\cos(\omega t+\pi/3),\;\;\;\; v_3=2000\cos(\omega t+\pi/3),\;\;\;\;
  v_C=200\sqrt{3}\cos(\omega t-\pi/3)
  \]
  \[
  i(t)=10\cos(\omega t),\;\;\;\;\;v(t)=4000\cos(\omega t)
  \]
