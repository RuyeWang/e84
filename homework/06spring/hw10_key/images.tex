...
\begin{displaymath} I_D=I_0 ( e^{V_D/\eta V_T}-1 ) \end{displaymath}%
\lthtmldisplayZ
\lthtmlcheckvsize\clearpage}
...
\begin{displaymath}	\frac{10-x}{300}=\frac{x-0.7}{200}+\frac{x-0.7}{100}	\end{displaymath}%
\lthtmldisplayZ
\lthtmlcheckvsize\clearpage}
