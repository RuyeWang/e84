...
\begin{displaymath} \dot{V}=\dot{V}_0 \frac{R_2|| Z_C}{R_1+R_2||Z_C}
  =10\angle{-45^\circ}\frac{(-j10 || 10)}{20+(-j10 || 10)}
  =2.77\angle{-79^\circ} \end{displaymath}%
\lthtmldisplayZ
\lthtmlcheckvsize\clearpage}

{\newpage\clearpage
\lthtmldisplayA{displaymath164}%
\begin{displaymath} v(t)=2.77\sqrt{2} \cos(314 t-79^\circ)=3.92 \cos(314 t-79^\circ) \end{displaymath}%
\lthtmldisplayZ
\lthtmlcheckvsize\clearpage}
...
$\tau=R_{eq}C=(R_1||R_2) C=20 || 10 \times 318\times 
  10^{-6}=2.12\times 10^{-3}$%
\lthtmlinlinemathZ
\lthtmlcheckvsize\clearpage}
...
$\displaystyle v_\infty(t)+[v(0)-v_\infty(0)]e^{-t/\tau}
...
$\displaystyle 3.92 \cos(314 t-79^\circ)-0.75 e^{-10^3 t/2.12}$%
\lthtmlindisplaymathZ
\lthtmlcheckvsize\clearpage}
