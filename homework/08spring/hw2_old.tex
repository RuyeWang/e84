...
% {\bf Solution:}
% \[ V_{out}=1.6\times \frac{10}{10+R_0}=1.4, \longrightarrow R_0=1.43 \Omega \]
...
\item Example 0 at the bottom of 
  \htmladdnormallink{this page}{../../../lectures/ch1/node9.html}
...
\item Example 0 at the bottom of 
  \htmladdnormallink{this page}{http://fourier.eng.hmc.edu/e84/lectures/ch1/node8.html}
