...
\htmladdimg{../M1250KSchematic.png}
...
\item {\bf Resistance measurement}
  ...
  \item Before taking the measurement of a given external resistance $R$, 
    the multimeter needs to be calibrated by adjusting R24 (the bottom part
    is x and the top part is 10-x), so that the meterhead shows a full scale
    display, when $R=0$ (with the two leads short circuited). Determin the 
    value of this x. 

  \item Calculate the value of R19 for the scale of the $\times 1\;k\Omega$
  ...
  \item Calibration:
    ...
    The resistance of the meterhead $R_m$ in parallel with R26 is:
    \[
  ...
  \item $\times 1\;k\Omega$ scale, $R=20\;k\Omega$
    ...
    The total current through the batery is
    \[
    \frac{3}{R+R19||R_t}
    \]
